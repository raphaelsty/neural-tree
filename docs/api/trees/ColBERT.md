...
- **model** (*neural_cherche.models.colbert.ColBERT*)

- **sentence_transformer** (*sentence_transformers.SentenceTransformer.SentenceTransformer | None*) – defaults to `None`

- **documents** (*list[dict] | None*) – defaults to `None`

- **graph** (*dict | None*) – defaults to `None`

- **leaf_balance_factor** (*int*) – defaults to `100`

- **branch_balance_factor** (*int*) – defaults to `5`
...
- **max_iter** (*int*) – defaults to `3000`

- **n_init** (*int*) – defaults to `100`
...
???- note "get_mapping_leafs"

    Returns mapping between leafs and their number.

    
???- note "get_negative_samples"

...
- **scoring** (*[scoring.SentenceTransformer](../../scoring/SentenceTransformer) | [scoring.TfIdf](../../scoring/TfIdf)*)
...
???- note "create_child"
    ...
    **Parameters**
    ...
    - **scoring**     (*neural_tree.scoring.sentence_transformer.SentenceTransformer | neural_tree.scoring.tfidf.TfIdf*)    
    - **max_iter**     (*int*)    
    - **n_init**     (*int*)    
    - **create_retrievers**     (*bool*)    
...
???- note "search"
    ...
    **Parameters**
    ...
    - **paths**     (*dict[list] | None*)     – defaults to `None`    
    - **tree_scores**     (*collections.defaultdict | None*)     – defaults to `None`    
    - **kwargs**    
